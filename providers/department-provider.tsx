...
type DepartmentContextValue = { ready: boolean; isAuthenticated: boolean; profile: OfficialProfile | null; complaints: Complaint[]; complaintsLoading: boolean; complaintsError?: string; loadComplaints: (force?: boolean) => Promise<void>; login: (profile: OfficialProfile) => Promise<void>; logout: () => Promise<void>; updateStatus: (id: string, status: ComplaintStatus, note?: string) => Promise<void>; addNote: (id: string, note: string) => Promise<void>; };
