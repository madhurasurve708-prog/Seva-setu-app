// app/(citizen)/complete-profile.tsx
...
import { LOCALITIES, WARDS } from '@/constants/citizen';
    ...
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.hero}>
        ...
        <SafeAreaView style={styles.heroSafeArea}>
          <Animated.View entering={FadeInUp.duration(600)} style={styles.heroContent}>
            ...
            <Text style={styles.heroTitle}>{t('completeProfile')}</Text>
            <Text style={styles.heroText}>{t('completeProfileDesc')}</Text>
          </Animated.View>
        </SafeAreaView>
      </View>
      ...
      >
        <Animated.View entering={FadeInDown.duration(500).delay(200)}>
          ...
          {/* Ward Selection */}
          <Text style={styles.label}>{t('selectWard')}</Text>
          <Text style={styles.subtextHint}>{t('selectWardHint')}</Text>
          ...
          {ward ? (
            <Animated.View entering={FadeInDown.duration(400)}>
              <Text style={styles.label}>{t('selectLocality')}</Text>
              <Text style={styles.subtextHint}>{t('selectLocalityHint')}</Text>
              <View style={styles.optionsGrid}>
